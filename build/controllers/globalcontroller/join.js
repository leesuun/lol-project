                        ...
                        switch ((_context.prev = _context.next)) {
                            case 0:
                                (_req$body = req.body),
                                    ...
                                    (statusCheck = _req$body.statusCheck);
                        ...
                        case 4:
                            ...
                            if (userId) {
                                ...
                                if (user) {
                                    ...
                                    !_regex["default"].userid.test(userId)
                                ) {
                                    state.msg =
                                        "6~15자 영문,숫자가 포함되어야 합니다.";
                                } else {
                            ...
                            if (password) {
                                ...
                                if (password === "blank") {
                                    ...
                                    !_regex["default"].password.test(password)
                                ) {
                                    state.msg =
                                        "6~20자 영문, 숫자 또는 특수문자가 포함되어야 합니다.";
                                } else {
                ...
                while (1) {
                    switch ((_context3.prev = _context3.next)) {
                        case 0:
                            ...
                            ACCOUNT_URL = "summoner/v4/summoners/by-name/"
                                .concat(nickname, "?api_key=")
                                .concat(process.env.API_KEY);
                            _context3.next = 5;
                            return (0, _nodeFetch["default"])(
                                ""
                                    .concat(process.env.LOL_BASE_URL)
                                    .concat(ACCOUNT_URL)
                            );
